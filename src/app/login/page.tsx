...
// import { Label } from "@/components/ui/label"; // Não usaremos Label agora, pois o placeholder fará esse papel
import { Input } from "@/components/ui/input";
import { useForm, SubmitHandler } from "react-hook-form";
import { AnimatePresence, motion } from "framer-motion";
import { cn } from "@/lib/utils"; // Ajuste se sua função de concat de classes estiver em outro local
      ...
      <div className="w-full max-w-sm md:max-w-3xl">
        <Card className="overflow-hidden relative">
          ...
          <CardContent className="grid p-0 md:grid-cols-2 relative">
            {/* Lado esquerdo: Área fixa com a classe "load-content" */}
            ...
            {/* Lado direito: Imagem estática apenas para desktop */}
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col">
          <Input
            ...
            {...register("email", { required: "Informe seu e-mail ou telefone." })}
          />
          {errors.email && (
        ...
        {/* Botão de Login e botão de Login com Google */}
        <div className="mt-4 flex flex-col items-center gap-4">
          ...
          <Button
            ...
            className="w-full flex items-center justify-center hover:bg-primary hover:text-white transition-colors"
          >
            <GoogleIcon />
            Entrar com Google
          </Button>
...
function GoogleIcon() {
  return (
    ...
    >
      <path
        fill="#EA4335"
        d="M24 9.5c3.54 0 6.72 1.22 9.24 3.22l6.87-6.87C36.31 4.12 30.5 2 24 2 14.64 2 6.55 7.53 2.77 15.03l7.62 5.92C12.56 14.05 17.69 9.5 24 9.5z"
      />
      <path
        fill="#4285F4"
        d="M46.98 24.5c0-1.65-.14-3.24-.4-4.75H24v9h12.8c-.55 2.94-2.23 5.43-4.75 7.1l7.26 5.64C44.62 38.45 46.98 32.91 46.98 24.5z"
      />
      <path
        fill="#FBBC05"
        d="M10.39 28.59a13.62 13.62 0 0 1 0-8.18l-7.62-5.92C.77 17.32 0 20.51 0 24s.77 6.68 2.77 9.31l7.62-5.92z"
      />
      <path
        fill="#34A853"
        d="M24 46c6.5 0 12.31-2.16 16.42-5.9l-7.26-5.64c-2.02 1.36-4.62 2.17-9.16 2.17-6.31 0-11.44-4.55-13.32-10.68l-7.62 5.92C6.55 40.47 14.64 46 24 46z"
      />
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full p-6 md:p-8">
      ...
      <Button
        ...
        type="submit"
        className="w-full bg-green-900 hover:bg-primary hover:text-white transition-colors"
      >
